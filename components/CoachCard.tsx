...
const CoachCard: React.FC<{ coach: ICoach }> = ({ coach }) => (
    <Link href={`/air-teach/coaches/${coach.id}`} className="hover:scale-[1.01] transition bg-white rounded-xl p-4 shadow-md m-2 h-40 w-full md:w-[47%] lg:w-[30%] xl:w-[23.5%] 2xl:w-[18.5%]">
